 ...
 * @author vanes
 */
public class TestTrajectoryCellSize_bk {
...
//        filename = "sanfrancisco_groundtruth_experimento[A2][formatted]";
        ...
        filename = "sanfrancisco_experimento[A2][formatted]";
        extension = ".csv";
//        int z;
////        if(args.length > 101 ){            
...
//        String[] lstCategoricalsPreDefined = {"PRICE","rating".toUpperCase(),"label".toUpperCase(),"checkin_id".toUpperCase(),"venue_id".toUpperCase()};
        String[] lstCategoricalsPreDefined = {"gid", "taxi_id", "semantic_stop_id", "semantic_move_id"};
...
//        double thresholdCellSize = 10; 
        ...
        method.execute(dir, filename, extension, lstCategoricalsPreDefined, SEPARATOR, valuesNulls, rc, threshold_rv);
    }
}
